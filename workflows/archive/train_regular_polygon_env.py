...
def initialize_environment():
    ...
    env = RegularPolygonEnv.from_config(env_config)
    return env
...
if __name__ == "__main__":
    ...
    num_actions = template_size * RegularPolygonEnv.get_num_actions_per_halfedge(max_edge_addition_steps)
    ...
    policy_kwargs = dict(
        ...
        features_extractor_kwargs=dict(
            input_features=RegularPolygonEnv.get_feature_size(),
