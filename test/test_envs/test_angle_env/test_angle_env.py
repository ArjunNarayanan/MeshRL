...
class TestHexEnvInitial(unittest.TestCase):
    ...
    def test_scores(self):
        self.assertAlmostEqual(self.env.template_face_score, 3)
        self.assertAlmostEqual(self.env.template_angle_score, 6)
...
class TestHexEnvSteps(unittest.TestCase):
    ...
    def test_scores(self):
        self.assertAlmostEqual(self.env.template_face_score, 2)
        self.assertAlmostEqual(self.env.template_angle_score, 4)
