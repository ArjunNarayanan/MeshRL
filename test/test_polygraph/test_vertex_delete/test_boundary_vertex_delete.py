...
class TestDeleteVertex(unittest.TestCase):
    ...
    def test_number_of_nodes(self):
        ...
        self.assertEqual(self.graph.number_of_halfedges(), 3)
    ...
    def test_number_of_edges(self):
        self.assertEqual(self.graph.number_of_edges_of_type("next"), 3)
        self.assertEqual(self.graph.number_of_edges_of_type("previous"), 3)
        self.assertEqual(self.graph.number_of_edges_of_type("twin"), 6)
        ...
        self.assertEqual(self.graph.number_of_edges(), 42)
    ...
    def test_previous_edges(self):
        ...
        htag = self.graph.halfedge_tag
        self.assertTrue(
            all(self.graph.previous_halfedge(idx) == (ne, htag) for (idx, ne) in enumerate(prev_edges))
        )
    ...
    def test_twin_edges(self):
        ...
        self.assertTrue(
            all(self.graph.twin_halfedge(idx) == (idx, btag) for idx in range(3))
        )
        self.assertTrue(all(self.graph.twin_halfedge((idx, btag)) == (idx, htag) for idx in range(3)))
